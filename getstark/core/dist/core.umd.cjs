...
var oe = (y, M, m) =>
  M in y
    ? re(y, M, { enumerable: !0, configurable: !0, writable: !0, value: m })
    : (y[M] = m)
var L = (y, M, m) => (oe(y, typeof M != "symbol" ? M + "" : M, m), m),
  X = (y, M, m) => {
    if (!M.has(y)) throw TypeError("Cannot " + m)
  }
var v = (y, M, m) => (
    X(y, M, "read from private field"), m ? m.call(y) : M.get(y)
  ),
  x = (y, M, m) => {
    if (M.has(y))
      throw TypeError("Cannot add the same private member more than once")
    M instanceof WeakSet ? M.add(y) : M.set(y, m)
  },
  U = (y, M, m, q) => (
    X(y, M, "write to private field"), q ? q.call(y, m) : M.set(y, m), m
  )
var j = (y, M, m) => (X(y, M, "access private method"), m)
;(function (y, M) {
  typeof exports == "object" && typeof module < "u"
    ? M(exports)
    : typeof define == "function" && define.amd
    ? define(["exports"], M)
    : ((y = typeof globalThis < "u" ? globalThis : y || self), M((y.core = {})))
})(this, function (exports) {
  var y, ee, m, W, B, te, Z, J, z, S, k, Y, ne, G, $
  ;("use strict")
  const generateUID = () =>
  ...
  function definePropertyGlobalVal(t, e, n) {
    Object.defineProperty(t, e, { value: n, configurable: !1, writable: !0 })
  }
  ...
  function setGlobalDefaultVal(t) {
    ...
    ;(a = (e = t.__FEDERATION__).__GLOBAL_PLUGIN__) != null ||
      (e.__GLOBAL_PLUGIN__ = [])
    var c
    ;(c = (n = t.__FEDERATION__).__INSTANCES__) != null ||
      (n.__INSTANCES__ = [])
    var l
  ...
  const getGlobalSnapshot = () => nativeGlobal.__FEDERATION__.moduleInfo,
    ...
    getRemoteEntryExports = (t, e) => {
      const n = e || `__FEDERATION_${t}:custom__`,
        r = globalThis[n]
      return { remoteEntryKey: n, entryExports: r }
    },
  ...
  function satisfy(t, e) {
    ...
    for (const h of o) {
      ...
      const [, b, , N, g, A, O] = p,
        I = {
          operator: b,
          version: combineVersion(N, g, A, O),
          major: N,
          minor: g,
          patch: A,
          preRelease: O == null ? void 0 : O.split("."),
        }
      if (!compare(I, d)) return !1
    }
    return !0
  }
  function _extends$6() {
        ...
        const { requiredVersion: l } = o,
          ...
          h = () => {
            if (o.singleton) {
              ...
              for (const [N, g] of Object.entries(t[c][e]))
                if (satisfy(N, l)) return g
            }
          },
          p = {
            shareScopeMap: t,
...
`.concat(r)
  ...
  function generateSnapshotFromManifest(t) {
    ...
    if (!Object.keys(s).length) {
      ...
      h =
        ((p = t.remotes) === null || p === void 0
          ? void 0
          : p.reduce(function (E, V) {
              var H,
                K = V.federationContainerName
              return (
                d.includes(K)
                  ? (H = a[K])
                  : "version" in V
                  ? (H = V.version)
                  : (H = V.entry),
                (E[K] = { matchedVersion: H }),
                E
              )
            }, {})) || {}
    }
    Object.keys(s).forEach(function (E) {
      return (h[E] = { matchedVersion: d.includes(E) ? a[E] : s[E] })
    })
    var b = t.metaData,
      N = b.remoteEntry,
      g = N.path,
      ...
      C = {
        ...
        buildVersion: T,
        globalName: F,
        remoteEntry: simpleJoinRemoteEntry(g, A),
        remoteEntryType: O,
        ...
        shared:
          t == null
            ? void 0
            : t.shared.map(function (E) {
                return { assets: E.assets, sharedName: E.name }
              }),
        modules:
          P == null
            ? void 0
    ...
    if (!((n = t.metaData) === null || n === void 0) && n.prefetchInterface) {
      var R = t.metaData.prefetchInterface
      C = _object_spread_props(_object_spread$1({}, C), {
        prefetchInterface: R,
      })
    }
    if (!((r = t.metaData) === null || r === void 0) && r.prefetchEntry) {
      var D = t.metaData.prefetchEntry,
        w = D.path,
        _ = D.name,
        Q = D.type
      C = _object_spread_props(_object_spread$1({}, C), {
        prefetchEntry: simpleJoinRemoteEntry(w, _),
        prefetchEntryType: Q,
      })
    }
    return (
      "publicPath" in t.metaData
        ? (l = _object_spread_props(_object_spread$1({}, C), {
            publicPath: u(),
          }))
        : (l = _object_spread_props(_object_spread$1({}, C), {
            getPublicPath: u(),
  ...
  function matchRemoteWithNameAndExpose(t, e) {
    for (const n of t) {
      ...
      if (r) {
        if (o.startsWith("/")) {
          const a = n.name
          return (o = `.${o}`), { pkgNameOrAlias: a, expose: o, remote: n }
        } else if (o === "")
      ...
      if (n.alias && s) {
        if (i && i.startsWith("/")) {
          const a = n.alias
          return (i = `.${i}`), { pkgNameOrAlias: a, expose: i, remote: n }
        } else if (i === "")
          return { pkgNameOrAlias: n.alias, expose: ".", remote: n }
      }
    }
  }
  ...
  async function loadEntryScript({
    ...
    return (
      ...
      `,
            ...
            .catch((s) => s)
        : loadScript(n, { attrs: {}, createScriptHook: r })
            .then(() => {
              const { remoteEntryKey: s, entryExports: i } =
                getRemoteEntryExports(t, e)
              return (
  ...
  let Module = class {
    async getEntry() {
      ...
      const e = await getRemoteEntry({
        ...
        createScriptHook: (n) => {
          const r = this.host.loaderHook.lifecycle.createScript.emit({ url: n })
 ...
 ${safeToString$1(this.remoteInfo)}`,
    ...
    async get(e, n) {
      const { loadFactory: r = !0 } = n || { loadFactory: !0 },
      ...
      if (!this.inited) {
        ...
        const l = a[c],
          u = [],
          d = { version: this.remoteInfo.version || "" }
        ...
        await o.init(h.shareScope, h.initScope, h.remoteEntryInitOptions),
          await this.host.hooks.lifecycle.initContainer.emit(
            _extends$4({}, h, { remoteEntryExports: o }),
          )
      }
      ...
      return (
        assert(
          ...
          `Unable to preload ${n.nameOrAlias} as it is not included in ${
            !r && safeToString$1({ remoteInfo: r, remotes: t })
          }`,
        ),
        { remote: r, preloadConfig: defaultPreloadArgs(n) }
      )
    })
  }
  ...
  function traverseModuleInfo(t, e, n, r, o = {}, s) {
    ...
    if (c && !isManifestProvider(c) && (n(c, e, r), c.remotesInfo)) {
      ...
      for (const u of l) {
        ...
        traverseModuleInfo(
          t,
          { name: d.name, version: h.matchedVersion },
          n,
          !1,
          o,
          void 0,
    ...
    traverseModuleInfo(
      ...
      (g, A, O) => {
        ...
        if (O) I = d
          ...
          const D = h.find(
            (w) => w.nameOrAlias === A.name || w.nameOrAlias === A.alias,
          )
          if (!D) return
          I = defaultPreloadArgs(D)
        } else if (h === !0) I = d
        else return
        const T = getResourceUrl(g, "remoteEntry" in g ? g.remoteEntry : "")
        T &&
          a.push({
            name: A.name,
            moduleInfo: {
              ...
              entryGlobalName: "globalName" in g ? g.globalName : A.name,
              shareScope: "",
              version: "version" in g ? g.version : void 0,
            },
            url: T,
          })
        let F = "modules" in g ? g.modules : []
        const P = normalizePreloadExposes(I.exposes)
        if (P.length && "modules" in g) {
          var C
          F =
            g == null || (C = g.modules) == null
              ? void 0
              : C.reduce(
                  (D, w) => (
                    (P == null ? void 0 : P.indexOf(w.moduleName)) !== -1 &&
                      D.push(w),
                    D
                  ),
                  [],
        ...
        function R(D) {
          const w = D.map((_) => getResourceUrl(g, _))
        ...
        if (F) {
          ...
          for (let w = 0; w < D; w++) {
            const _ = F[w],
              Q = `${A.name}/${_.moduleName}`
            t.hooks.lifecycle.handlePreloadModule.emit({
              id: _.moduleName === "." ? A.name : Q,
              name: A.name,
              remoteSnapshot: g,
              preloadConfig: I,
              remote: A,
              ...
              !getPreloaded(Q) &&
                (I.resourceCategory === "all"
                  ? (s.push(...R(_.assets.css.async)),
                    s.push(...R(_.assets.css.sync)),
                    i.push(...R(_.assets.js.async)),
                    i.push(...R(_.assets.js.sync)))
      ...
      o.shared &&
        o.shared.forEach((g) => {
          var A
          const O = (A = u.shared) == null ? void 0 : A[g.sharedName]
          if (!O) return
          ...
          I &&
            ...
            (g.assets.js.sync.forEach((T) => {
              c.add(T)
            }),
            g.assets.css.sync.forEach((T) => {
              l.add(T)
            }))
        })
    const b = i.filter((g) => !c.has(g))
    return {
      cssAssets: s.filter((g) => !l.has(g)),
      jsAssetsWithoutEntry: b,
      entryAssets: a,
    }
  }
  ...
  class SnapshotHandler {
    async loadSnapshot(e) {
      ...
      return { remoteSnapshot: i, globalSnapshot: a }
    }
        ...
        if (isManifestProvider(a)) {
          const l = await this.getManifestJson(a.remoteEntry, e, {}),
            u = setGlobalSnapshotInfoByModuleInfo(
              _extends$1({}, e, { entry: a.remoteEntry }),
              l,
            )
          return { remoteSnapshot: l, globalSnapshot: u }
        } else {
          ...
          return { remoteSnapshot: l, globalSnapshot: c }
        }
 ...
 ${a}`)
        ...
        s = async () => {
          const i = await o(),
            a = generateSnapshotFromManifest(i, { version: e }),
            { remoteSnapshot: c } =
              await this.hooks.lifecycle.loadRemoteSnapshot.emit({
                options: this.HostInstance.options,
                moduleInfo: n,
  ...
  class FederationHost {
    ...
    initRawContainer(e, n, r) {
      const o = getRemoteInfo({ name: e, entry: n }),
    ...
    async _getRemoteModuleAndOptions(e) {
      ...
      return (
        ...
        { module: u, moduleOptions: d, remoteMatchInfo: a }
      )
    }
    async loadRemote(e, n) {
      try {
        ...
        const { from: o = "runtime" } = n || { from: "runtime" },
    ...
    initializeSharing(e = DEFAULT_SCOPE, n) {
      ...
      const s = r[e],
        i = (u, d) => {
          var h
          const { version: p, eager: b } = d
          s[u] = s[u] || {}
          const N = s[u],
            g = N[p],
            A = Boolean(
              g &&
                (g.eager || ((h = g.shareConfig) == null ? void 0 : h.eager)),
            )
          ;(!g ||
            (g.strategy !== "loaded-first" &&
              !g.loaded &&
              (Boolean(!b) !== !A ? b : o > g.from))) &&
            (N[p] = d)
        },
        a = [],
    ...
    formatOptions(e, n) {
      const r = formatShareConfigs(n.shared || {}, n.name),
        ...
        c = (s.remotes || []).reduce(
          (h, p) => (this.registerRemote(p, h, { force: !1 }), h),
          i.remotes,
        )
      ...
      const d = _extends({}, e, n, { plugins: u, remotes: c, shared: o })
      return this.hooks.lifecycle.init.emit({ origin: this, options: d }), d
    }
    registerPlugins(e) {
      registerPlugins(e, [
        this.hooks,
      ...
      return (
        ...
        (t.prototype._dispatchItem = function (e) {
          ...
          ;(this._value -= e.weight),
            e.resolve([n, this._newReleaser(e.weight)])
        }),
  ...
  class MetaMaskVirtualWallet {
    constructor() {
      ...
      x(this, m)
      x(this, B)
      L(this, "id", "metamask-snaps")
      L(this, "name", "MetaMask Snaps")
      L(
        this,
        "icon",
      ...
      L(this, "windowKey", "starknet_metamask")
      L(this, "provider", null)
      L(this, "swo", null)
      L(this, "lock")
      L(this, "version", "v2.0.0")
      this.lock = new Mutex()
    }
    async loadWallet(e) {
      return await j(this, m, W).call(this, e), this
    }
    async hasSupport(e) {
      return (
  ...
  ;(y = new WeakSet()),
    ...
    (m = new WeakSet()),
    (W = async function (e = window) {
      return this.lock.runExclusive(
        async () => (
          this.swo ||
            ((this.swo = await j(this, y, ee).call(this, e)),
            j(this, B, te).call(this)),
          this.swo
        ),
      )
    }),
      ...
      },
      {
        ...
        downloads: {
          ...
          ios: `https://link.braavos.app/dapp/${
            (Z = ssrSafeWindow == null ? void 0 : ssrSafeWindow.location) ==
            null
              ? void 0
              : Z.host
          }`,
          android: `https://link.braavos.app/dapp/${
            (J = ssrSafeWindow == null ? void 0 : ssrSafeWindow.location) ==
            null
              ? void 0
              : J.host
          }`,
  ...
  class LocalStorageWrapper {
    constructor(e) {
      ...
      x(this, k, void 0)
      L(this, "value")
      U(this, k, e), j(this, G, $).call(this)
    }
    set(e) {
      return !v(this, z) && !j(this, G, $).call(this)
        ? !1
        : (this.delete(),
          (this.value = e),
          e &&
            (U(this, S, `${v(this, k)}-${generateUID()}`),
            localStorage.setItem(v(this, S), e)),
          !0)
    }
    get() {
      return j(this, Y, ne).call(this), this.value
    }
    delete() {
      return !v(this, z) && !j(this, G, $).call(this)
        ? !1
        : ((this.value = null),
          v(this, S) && localStorage.removeItem(v(this, S)),
          !0)
    }
  }
  ;(z = new WeakMap()),
      ...
      try {
        !v(this, z) &&
          ...
          (U(
            this,
            S,
            Object.keys(localStorage).find((e) => e.startsWith(v(this, k))),
          ),
          U(this, z, !0),
          v(this, S) && this.set(localStorage.getItem(v(this, S))))
      } catch (e) {
        console.warn(e)
      }
      return v(this, z)
  ...
  async function waitForEVMProvider(t, e = {}) {
    ...
    return r === 0
      ...
      : waitForEVMProvider(t, { timeout: n, retries: r - 1 })
  }
  ...
  const filterByAuthorized = async (t) => {
      const e = await Promise.all(
        t.map(async (n) => {
          try {
            return (
              await n.request({ type: "wallet_getPermissions" })
    ...
    return (
      i(),
      {
        ...
        enable: async (a, c) => {
          ...
          const u = await l.request({ type: "wallet_getPermissions" })
  ...
  ;(exports.default = main),
    ...
    (exports.isWalletObject = isWalletObject),
    (exports.scanObjectForWallets = scanObjectForWallets),
    (exports.ssrSafeWindow = ssrSafeWindow),
