  ...
  return {
    ...
    p(h, M) {
      M & 1 && n !== (n = h[20].name + "") && set_data(o, n),
        ...
        M & 1 && u !== (u = h[20].name + " download link") && attr(e, "alt", u),
...
function instance(t, e, r) {
  ...
  a === "dark" ||
  (a === null &&
    (n == null ? void 0 : n.matchMedia("(prefers-color-scheme: dark)").matches))
    ? (m = "dark")
    : (m = "")
  const p = (y) => {
  ...
  getTargetSnapshotInfoByModuleInfo = (t, e) => {
    ...
    if ("version" in t && t.version) {
      const { version: o } = t,
        ...
        i = getFMId(s),
        l = getInfoWithoutType(nativeGlobal.__FEDERATION__.moduleInfo, i).value
...
function generateSnapshotFromManifest(t) {
  ...
  Object.keys(s).forEach(function (S) {
    return (m[S] = {
      matchedVersion: d.includes(S) ? l[S] : s[S],
    })
  })
  var h = t.metaData,
    M = h.remoteEntry,
...
function _iterable_to_array_limit(t, e) {
  ...
  if (r != null) {
    ...
    try {
      for (
        r = r.call(t);
        !(o = (i = r.next()).done) && (n.push(i.value), !(e && n.length === e));
        o = !0
      );
    } catch (c) {
      ;(s = !0), (l = c)
...
class SnapshotHandler {
 ...
 ${l}`)
      ...
      s = async () => {
        const i = await o(),
          l = generateSnapshotFromManifest(i, {
            version: e,
          }),
          { remoteSnapshot: c } =
            await this.hooks.lifecycle.loadRemoteSnapshot.emit({
    ...
    const s = n[e],
      i = (u, d) => {
        ...
        const M = s[u],
          A = M[p],
          g = Boolean(
            A && (A.eager || ((m = A.shareConfig) == null ? void 0 : m.eager)),
          )
        ;(!A ||
...
const commonVersionIdentifier = /version\/(\d+(\.?_?\d+)+)/i,
    ...
    },
    {
      ...
      describe(t) {
        const e = {
          ...
          r =
            Utils.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i, t) ||
            Utils.getFirstMatch(commonVersionIdentifier, t)
        return r && (e.version = r), e
      },
    },
  ...
  osParsersList = [
    ...
    },
    {
      test: [/macintosh/i],
      describe(t) {
        const e = Utils.getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i, t).replace(
            /[_\s]/g,
            ".",
          ),
